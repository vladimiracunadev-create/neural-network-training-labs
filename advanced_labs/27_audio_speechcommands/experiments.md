# Plan de experimentos — Clasificación de audio con SpeechCommands

<!-- nav-top -->
> 🧭 **Clase 28 / 31** · 🔬 [Módulo 7 — Especializaciones avanzadas](../../parts/07-especializaciones-avanzadas.md)
>
> [⬅️ 🧷 Segmentación semántica con U-Net](../../advanced_labs/26_segmentation_unet/experiments.md) · [🏠 Índice de clases](../../parts/README.md) · [🖌️ WGAN-GP sobre Fashion-MNIST ➡️](../../advanced_labs/28_wgan_gp/experiments.md)
>
...
Formulada como algo que se puede refutar: **el modelo de este laboratorio supera a MFCC + regresión logística en `accuracy`, y la diferencia es mayor que la dispersión entre semillas.**

Qué la haría falsa —y esto también es un resultado que hay que reportar—:

- El modelo no supera a MFCC + regresión logística.
...
Además de la comparación con la línea base, aquí interesa una pregunta específica: **Comparar señal limpia, ruido añadido y SpecAugment usando los splits oficiales**. Es la comparación que da sentido al tema de este laboratorio; la de la línea base solo dice si el modelo sirve, mientras que esta dice *qué parte* del diseño es la que aporta.
...
```bash
neural-labs train-advanced --track 27_audio_speechcommands --split-seed 42 --training-seed 41
neural-labs train-advanced --track 27_audio_speechcommands --split-seed 42 --training-seed 42
...
5. **Vuelve a la línea base.** La comparación contra MFCC + regresión logística es la que dice si todo el aparato de la red neuronal estaba justificado para este problema.
