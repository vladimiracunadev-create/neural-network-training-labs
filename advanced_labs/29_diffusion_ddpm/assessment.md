...
>
> [⬅️ 🖌️ WGAN-GP sobre Fashion-MNIST](../../advanced_labs/28_wgan_gp/assessment.md) · [🏠 Índice de rutas](../../parts/README.md) · [🪞 Aprendizaje autosupervisado SimCLR ➡️](../../advanced_labs/30_self_supervised_simclr/assessment.md)
>
...
**1. Explica con tus palabras: Proceso directo de ruido, predicción de epsilon, cronograma beta y muestreo inverso.**
...
**3. ¿Por qué Autoencoder generativo simple es una comparación razonable para este problema?**
...
**4. ¿Qué te dice `noise_mse` que no te dirían las otras métricas?**
