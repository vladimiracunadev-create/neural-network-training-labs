...
| 📏 Línea base a superar | Autoencoder generativo simple |
...
Es la **ruta 30 de 31** y pertenece a 🔬 [la parte 7, Especializaciones avanzadas](../../parts/07-especializaciones-avanzadas.md). Llegas desde [🖌️ WGAN-GP sobre Fashion-MNIST](../../advanced_labs/28_wgan_gp/README.md) y lo que aprendas aquí lo da por supuesto [🪞 Aprendizaje autosupervisado SimCLR](../../advanced_labs/30_self_supervised_simclr/README.md).

**Entrada del modelo:** imágenes Fashion-MNIST normalizadas.

## 🧠 La idea que se pone a prueba

Este laboratorio trabaja **Proceso directo de ruido, predicción de epsilon, cronograma beta y muestreo inverso**.
...
**Métricas que se reportan:** `noise_mse`, `sample_diversity`, `sampling_latency`, `reconstruction_proxy`. La selección del modelo se decide con `noise_mse` sobre `validation`.
