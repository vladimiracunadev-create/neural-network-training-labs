# Guía docente — Clase 30: Difusión DDPM sobre Fashion-MNIST
...
> **¿Cómo aprende un modelo a invertir un proceso que destruye gradualmente la imagen?**
...
Visualizar la cadena directa e inversa y comparar calidad y latencia al cambiar pasos y cronograma.
...
> **Idea engañosa:** Menor error de predicción de ruido no garantiza automáticamente muestras perceptualmente mejores.
