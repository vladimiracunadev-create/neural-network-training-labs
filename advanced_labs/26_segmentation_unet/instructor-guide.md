# Guía docente — Clase 27: Segmentación semántica con U-Net
...
> **¿Cómo recupera una U-Net el detalle espacial que pierde al comprimir?**
...
Superponer máscaras, inspeccionar skip connections y comparar IoU por clase y errores de contorno.
...
> **Idea engañosa:** Una pixel accuracy alta puede ocultar una segmentación inútil cuando el fondo domina la imagen.
