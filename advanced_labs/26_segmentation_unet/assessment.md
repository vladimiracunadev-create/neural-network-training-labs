...
>
> [⬅️ 🔧 Fine-tuning eficiente de transformer](../../advanced_labs/25_transformer_finetuning/assessment.md) · [🏠 Índice de clases](../../parts/README.md) · [🎙️ Clasificación de audio con SpeechCommands ➡️](../../advanced_labs/27_audio_speechcommands/assessment.md)
>
...
**1. ¿Cómo recupera una U-Net el detalle espacial que pierde al comprimir?**
...
**2. Explica con tus palabras: Arquitectura encoder-decoder, conexiones skip, pérdida por píxel e intersección sobre unión.**
...
**4. ¿Por qué Máscara de clase mayoritaria es una comparación razonable para este problema?**
...
**5. ¿Qué aprendiste al realizar esta práctica: Superponer máscaras, inspeccionar skip connections y comparar IoU por clase y errores de contorno.?**
...
**6. Refuta con evidencia esta idea frecuente: «Una pixel accuracy alta puede ocultar una segmentación inútil cuando el fondo domina la imagen.»**
...
**7. ¿Qué te dice `mean_iou` que no te dirían las otras métricas?**
