...
>
> [⬅️ 🎙️ Clasificación de audio con SpeechCommands](../../advanced_labs/27_audio_speechcommands/assessment.md) · [🏠 Índice de rutas](../../parts/README.md) · [🌫️ Difusión DDPM sobre Fashion-MNIST ➡️](../../advanced_labs/29_diffusion_ddpm/assessment.md)
>
...
**1. Explica con tus palabras: Distancia Wasserstein, crítico sin sigmoide y restricción Lipschitz mediante gradient penalty.**
...
**3. ¿Por qué DCGAN convolucional es una comparación razonable para este problema?**
...
**4. ¿Qué te dice `wasserstein_estimate` que no te dirían las otras métricas?**
