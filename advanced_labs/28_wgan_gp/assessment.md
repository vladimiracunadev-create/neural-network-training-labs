# Evaluación — WGAN-GP sobre Fashion-MNIST

<!-- nav-top -->
> 🧭 **Clase 29 / 31** · 🔬 [Módulo 7 — Especializaciones avanzadas](../../parts/07-especializaciones-avanzadas.md)
>
> [⬅️ 🎙️ Clasificación de audio con SpeechCommands](../../advanced_labs/27_audio_speechcommands/assessment.md) · [🏠 Índice de clases](../../parts/README.md) · [🌫️ Difusión DDPM sobre Fashion-MNIST ➡️](../../advanced_labs/29_diffusion_ddpm/assessment.md)
>
...
| Comparación contra DCGAN convolucional | `metrics.json` y `baseline_metrics.json` | Sin línea base, una métrica no dice si el modelo aporta algo. |
...
**1. ¿Por qué controlar la norma del gradiente estabiliza el juego generativo?**
...
**2. Explica con tus palabras: Distancia Wasserstein, crítico sin sigmoide y restricción Lipschitz mediante gradient penalty.**
...
**4. ¿Por qué DCGAN convolucional es una comparación razonable para este problema?**
...
**5. ¿Qué aprendiste al realizar esta práctica: Graficar normas del gradiente, comparar DCGAN y WGAN-GP y revisar diversidad con igual presupuesto.?**
...
**6. Refuta con evidencia esta idea frecuente: «La estimación Wasserstein de una ejecución no es una métrica absoluta comparable entre cualquier arquitectura o escala.»**
...
**7. ¿Qué te dice `wasserstein_estimate` que no te dirían las otras métricas?**
...
*Qué se busca:* Aquí se evalúa el criterio, no la técnica: licencias y condiciones de uso de `fashion_mnist`, representatividad de la población, calibración de las probabilidades, vigilancia de la deriva, desempeño por subgrupo y supervisión humana. Un «funcionaría bien» sin condiciones se corrige como respuesta incompleta.
