...
>
> [⬅️ 🌫️ Difusión DDPM sobre Fashion-MNIST](../../advanced_labs/29_diffusion_ddpm/assessment.md) · [🏠 Índice de rutas](../../parts/README.md) · *fin del recorrido* ➡️
>
...
**1. Explica con tus palabras: Dos vistas, similitud coseno, pérdida NT-Xent y evaluación linear probe.**
...
**3. ¿Por qué ResNet18 aleatoria + linear probe es una comparación razonable para este problema?**
...
**4. ¿Qué te dice `nt_xent` que no te dirían las otras métricas?**
