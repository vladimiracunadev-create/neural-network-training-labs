# Evaluación — Aprendizaje autosupervisado SimCLR

<!-- nav-top -->
> 🧭 **Clase 31 / 31** · 🔬 [Módulo 7 — Especializaciones avanzadas](../../parts/07-especializaciones-avanzadas.md)
>
> [⬅️ 🌫️ Difusión DDPM sobre Fashion-MNIST](../../advanced_labs/29_diffusion_ddpm/assessment.md) · [🏠 Índice de clases](../../parts/README.md) · *fin del recorrido* ➡️
>
...
| Comparación contra ResNet18 aleatoria + linear probe | `metrics.json` y `baseline_metrics.json` | Sin línea base, una métrica no dice si el modelo aporta algo. |
...
**1. ¿Qué invariancias aprende una representación cuando nadie le entrega etiquetas?**
...
**2. Explica con tus palabras: Dos vistas, similitud coseno, pérdida NT-Xent y evaluación linear probe.**
...
**4. ¿Por qué ResNet18 aleatoria + linear probe es una comparación razonable para este problema?**
...
**5. ¿Qué aprendiste al realizar esta práctica: Inspeccionar pares aumentados, proyectar embeddings y comparar k-NN y linear probe bajo distintas intensidades de aumento.?**
...
**6. Refuta con evidencia esta idea frecuente: «Los aumentos definen lo que el modelo considera irrelevante; una invariancia mal elegida puede borrar la señal necesaria.»**
...
**7. ¿Qué te dice `nt_xent` que no te dirían las otras métricas?**
