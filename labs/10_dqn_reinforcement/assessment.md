...
**1. Explica con tus palabras: y=r+γ max_a Q_target(s′,a); la demanda de cada paso proviene del historial real, no de un generador.**
...
**3. ¿Por qué Política de reposición periódica basada en demanda media histórica es una comparación razonable para este problema?**
...
**5. ¿Qué te dice `mean_return` que no te dirían las otras métricas?**
