...
>
> [⬅️ ⚙️ Optimizadores y schedulers](../../labs/18_optimizers_and_schedulers/assessment.md) · [🏠 Índice de clases](../../parts/README.md) · [🔄 Aumento de datos ➡️](../../labs/20_data_augmentation/assessment.md)
>
...
| Comparación contra MLP sin regularización | `metrics.json` y `baseline_metrics.json` | Sin línea base, una métrica no dice si el modelo aporta algo. |
...
**1. ¿Cómo distinguir una red que aprendió una regla de otra que memorizó ejemplos?**
...
**2. Explica con tus palabras: Regularización explícita e implícita; brecha train-validation.**
...
**4. ¿Por qué MLP sin regularización es una comparación razonable para este problema?**
...
**5. ¿Qué técnica reduce sobreajuste sin subajustar?**
...
**6. ¿Qué aprendiste al realizar esta práctica: Comparar curvas train–validation, activar regularizadores por separado y medir estabilidad entre semillas.?**
...
**7. Refuta con evidencia esta idea frecuente: «Dropout y batch normalization no son equivalentes ni deben activarse de la misma manera durante inferencia.»**
