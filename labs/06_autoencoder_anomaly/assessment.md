...
>
> [⬅️ 📈 LSTM para series temporales](../../labs/05_lstm_time_series/assessment.md) · [🏠 Índice de clases](../../parts/README.md) · [🔭 Transformer para noticias ➡️](../../labs/07_transformer_attention/assessment.md)
>
...
| Comparación contra Isolation Forest | `metrics.json` y `baseline_metrics.json` | Sin línea base, una métrica no dice si el modelo aporta algo. |
...
**1. ¿Cuándo un error de reconstrucción se convierte en evidencia de anomalía?**
...
**2. Explica con tus palabras: Minimizar ||x-decoder(encoder(x))||² sobre transacciones normales.**
...
**4. ¿Por qué Isolation Forest es una comparación razonable para este problema?**
...
**5. ¿Qué costo tiene priorizar recall frente a precision?**
...
**6. ¿Qué aprendiste al realizar esta práctica: Comparar reconstrucciones, estudiar las distribuciones de error y elegir el umbral únicamente con validation.?**
...
**7. Refuta con evidencia esta idea frecuente: «Un error alto no prueba fraude; señala una observación distinta de las aprendidas y necesita interpretación contextual.»**
...
*Qué se busca:* Aquí se evalúa el criterio, no la técnica: licencias y condiciones de uso de `credit_card_fraud`, representatividad de la población, calibración de las probabilidades, vigilancia de la deriva, desempeño por subgrupo y supervisión humana. Un «funcionaría bien» sin condiciones se corrige como respuesta incompleta.
