...
>
> [⬅️ 📦 Exportación e inferencia](../../labs/23_model_export_and_inference/assessment.md) · [🏠 Índice de clases](../../parts/README.md) · [🔧 Fine-tuning eficiente de transformer ➡️](../../advanced_labs/25_transformer_finetuning/assessment.md)
>
...
| Comparación contra Regresión logística y Gradient Boosting | `metrics.json` y `baseline_metrics.json` | Sin línea base, una métrica no dice si el modelo aporta algo. |
...
**1. ¿Cómo se convierte una probabilidad de abandono en una decisión responsable de negocio?**
...
**2. Explica con tus palabras: Clasificación, calibración, selección de umbral y costo de errores.**
...
**4. ¿Por qué Regresión logística y Gradient Boosting es una comparación razonable para este problema?**
...
**5. ¿Cómo convertir resultados en una decisión responsable?**
...
**6. ¿Qué aprendiste al realizar esta práctica: Recorrer el proyecto completo, construir una matriz de costos y defender una recomendación con límites explícitos.?**
...
**7. Refuta con evidencia esta idea frecuente: «Predecir churn no demuestra por qué una persona se irá ni qué intervención logrará retenerla.»**
