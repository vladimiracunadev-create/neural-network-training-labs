# Guía docente — Clase 25: Proyecto final: churn de telecomunicaciones
...
> **¿Cómo se convierte una probabilidad de abandono en una decisión responsable de negocio?**
...
Recorrer el proyecto completo, construir una matriz de costos y defender una recomendación con límites explícitos.
...
> **Idea engañosa:** Predecir churn no demuestra por qué una persona se irá ni qué intervención logrará retenerla.
