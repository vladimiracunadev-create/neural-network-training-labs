...
1. Explique con sus palabras: Inicializar con pesos ImageNet y ajustar capas seleccionadas.
2. ¿Qué información del dataset solo puede utilizarse durante entrenamiento?
3. ¿Por qué la línea base **CNN pequeña entrenada desde cero** es una comparación razonable?
