...
>
> [⬅️ 🕹️ DQN para inventario con demanda real](../../labs/10_dqn_reinforcement/assessment.md) · [🏠 Índice de clases](../../parts/README.md) · [🔀 Fusión de sensores ➡️](../../labs/12_multimodal_fusion/assessment.md)
>
...
| Comparación contra CNN pequeña entrenada desde cero | `metrics.json` y `baseline_metrics.json` | Sin línea base, una métrica no dice si el modelo aporta algo. |
...
**1. ¿Cuándo conviene reutilizar representaciones y cuándo hay que volver a aprenderlas?**
...
**2. Explica con tus palabras: Inicializar con pesos ImageNet y ajustar capas seleccionadas.**
...
**4. ¿Por qué CNN pequeña entrenada desde cero es una comparación razonable para este problema?**
...
**5. ¿Cuándo el preentrenamiento deja de aportar?**
...
**6. ¿Qué aprendiste al realizar esta práctica: Comparar extracción de características, fine-tuning y entrenamiento desde cero con igual presupuesto.?**
...
**7. Refuta con evidencia esta idea frecuente: «Fine-tuning no siempre gana; con pocos datos o una tasa alta puede destruir representaciones útiles.»**
