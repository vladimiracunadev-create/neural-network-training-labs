...
>
> [⬅️ 🎯 Incertidumbre y calibración](../../labs/22_uncertainty_calibration/assessment.md) · [🏠 Índice de clases](../../parts/README.md) · [🏁 Proyecto final: churn de telecomunicaciones ➡️](../../labs/24_capstone_real_project/assessment.md)
>
...
| Comparación contra PyTorch eager | `metrics.json` y `baseline_metrics.json` | Sin línea base, una métrica no dice si el modelo aporta algo. |
...
**1. ¿Sigue siendo el mismo modelo después de exportarlo y optimizarlo?**
...
**2. Explica con tus palabras: Paridad numérica y costo de inferencia.**
...
**4. ¿Por qué PyTorch eager es una comparación razonable para este problema?**
...
**5. ¿Qué compromisos existen entre tamaño, latencia y precisión?**
...
**6. ¿Qué aprendiste al realizar esta práctica: Comparar salidas PyTorch–ONNX, medir latencia y tamaño y visualizar el frente de compromiso.?**
...
**7. Refuta con evidencia esta idea frecuente: «Exportar sin errores solo prueba que se creó un archivo; no prueba paridad, velocidad ni compatibilidad reales.»**
...
*Qué se busca:* Aquí se evalúa el criterio, no la técnica: licencias y condiciones de uso de `cifar10`, representatividad de la población, calibración de las probabilidades, vigilancia de la deriva, desempeño por subgrupo y supervisión humana. Un «funcionaría bien» sin condiciones se corrige como respuesta incompleta.
