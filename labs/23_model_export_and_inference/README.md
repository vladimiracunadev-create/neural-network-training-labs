...
Es la **ruta 24 de 31** y pertenece a ⚫ [la parte 6, Confiar en el modelo y sacarlo del cuaderno](../../parts/06-confianza-y-despliegue.md). Llegas desde [🎯 Incertidumbre y calibración](../../labs/22_uncertainty_calibration/README.md) y lo que aprendas aquí lo da por supuesto [🏁 Proyecto final: churn de telecomunicaciones](../../labs/24_capstone_real_project/README.md).

## 🧠 La idea que se pone a prueba

Este laboratorio trabaja **Paridad numérica y costo de inferencia**.
...
> **La pregunta que deberías poder responder al final:** ¿Qué compromisos existen entre tamaño, latencia y precisión?

**Métricas que se reportan:** `accuracy`, `latency_ms`, `throughput`, `model_size_mb`. La selección del modelo se decide con `macro_f1` sobre `validation`.
