...
>
> [⬅️ 🖼️ CNN para visión](../../labs/03_cnn_vision/assessment.md) · [🏠 Índice de clases](../../parts/README.md) · [📈 LSTM para series temporales ➡️](../../labs/05_lstm_time_series/assessment.md)
>
...
**1. ¿Cuánta información del comienzo de una secuencia llega realmente al final?**
...
**2. Explica con tus palabras: h_t=tanh(W_x x_t + W_h h_{t-1}+b).**
...
**5. ¿Qué información se pierde al truncar las reseñas?**
...
**6. ¿Qué aprendiste al realizar esta práctica: Seguir el estado oculto, comparar longitudes y observar cómo el gradiente se debilita o explota con la distancia.?**
...
**7. Refuta con evidencia esta idea frecuente: «El último estado no contiene necesariamente toda la secuencia; la información puede degradarse mucho antes de llegar a él.»**
...
*Qué se busca:* Aquí se evalúa el criterio, no la técnica: licencias y condiciones de uso de `imdb`, representatividad de la población, calibración de las probabilidades, vigilancia de la deriva, desempeño por subgrupo y supervisión humana. Un «funcionaría bien» sin condiciones se corrige como respuesta incompleta.
