...
>
> [⬅️ 🖼️ CNN para visión](../../labs/03_cnn_vision/experiments.md) · [🏠 Índice de clases](../../parts/README.md) · [📈 LSTM para series temporales ➡️](../../labs/05_lstm_time_series/experiments.md)
>
...
Formulada como algo que se puede refutar: **el modelo de este laboratorio supera a TF-IDF + regresión logística en `f1`, y la diferencia es mayor que la dispersión entre semillas.**
...
Además de la comparación con la línea base, aquí interesa una pregunta específica: **Comparar longitud máxima, embedding y regularización**. Es la comparación que da sentido al tema de este laboratorio; la de la línea base solo dice si el modelo sirve, mientras que esta dice *qué parte* del diseño es la que aporta.
...
```bash
neural-labs benchmark --lab 04_rnn_sequences \
