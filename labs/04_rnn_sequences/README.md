...
![ruta](https://img.shields.io/badge/ruta-5%20de%2031-7c5cff?style=flat-square) ![nivel](https://img.shields.io/badge/nivel-intermedio-1f6feb?style=flat-square) ![categoría](https://img.shields.io/badge/categoría-Central-2e8b57?style=flat-square) ![horas](https://img.shields.io/badge/horas-~6%20h-f0b429?style=flat-square) ![dataset](https://img.shields.io/badge/dataset-imdb-1f6feb?style=flat-square) ![selección](https://img.shields.io/badge/selección-f1-8957e5?style=flat-square)

| Campo | Valor |
|---|---|
| 🧭 Posición | Ruta **5 de 31** del recorrido · categoría central |
| 🎚️ Nivel | intermedio |
| ⏱️ Dedicación estimada | 6 horas |
| 🧩 Tarea | `binary_classification` |
| 🏗️ Arquitectura | `rnn_text` |
| 🗄️ Dataset | [`imdb`](https://huggingface.co/datasets/stanfordnlp/imdb) — Hugging Face / Stanford |
| ⚖️ Licencia del dataset | Consultar dataset card |
...
> Si alguno te falta, retrocede antes de continuar. Viniendo de [🖼️ CNN para visión](../../labs/03_cnn_vision/README.md).
...
Es la **ruta 5 de 31** y pertenece a 🔵 [la parte 2, Arquitecturas según la forma del dato](../../parts/02-arquitecturas.md). Llegas desde [🖼️ CNN para visión](../../labs/03_cnn_vision/README.md) y lo que aprendas aquí lo da por supuesto [📈 LSTM para series temporales](../../labs/05_lstm_time_series/README.md).

## 🧠 La idea que se pone a prueba

Este laboratorio trabaja **h_t=tanh(W_x x_t + W_h h_{t-1}+b)**.
...
> **La pregunta que deberías poder responder al final:** ¿Qué información se pierde al truncar las reseñas?
