...
>
> [⬅️ 🔄 Aumento de datos](../../labs/20_data_augmentation/assessment.md) · [🏠 Índice de rutas](../../parts/README.md) · [🎯 Incertidumbre y calibración ➡️](../../labs/22_uncertainty_calibration/assessment.md)
>
...
**1. Explica con tus palabras: Atribución por integración del gradiente entre baseline y entrada.**
...
**3. ¿Por qué Regresión logística interpretable es una comparación razonable para este problema?**
...
**5. ¿Qué te dice `f1` que no te dirían las otras métricas?**
