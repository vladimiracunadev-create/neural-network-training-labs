...
>
> [⬅️ 🔄 Aumento de datos](../../labs/20_data_augmentation/assessment.md) · [🏠 Índice de clases](../../parts/README.md) · [🎯 Incertidumbre y calibración ➡️](../../labs/22_uncertainty_calibration/assessment.md)
>
...
| Comparación contra Regresión logística interpretable | `metrics.json` y `baseline_metrics.json` | Sin línea base, una métrica no dice si el modelo aporta algo. |
...
**1. ¿Una explicación describe al modelo o solo produce una historia plausible?**
...
**2. Explica con tus palabras: Atribución por integración del gradiente entre baseline y entrada.**
...
**4. ¿Por qué Regresión logística interpretable es una comparación razonable para este problema?**
...
**5. ¿La explicación es estable ante pequeñas perturbaciones?**
...
**6. ¿Qué aprendiste al realizar esta práctica: Comparar atribuciones locales y globales, perturbar entradas y medir estabilidad de la explicación.?**
...
**7. Refuta con evidencia esta idea frecuente: «Una atribución alta no demuestra causalidad ni convierte una asociación del modelo en una razón del mundo real.»**
...
**8. ¿Qué te dice `f1` que no te dirían las otras métricas?**
...
*Qué se busca:* Aquí se evalúa el criterio, no la técnica: licencias y condiciones de uso de `adult_census`, representatividad de la población, calibración de las probabilidades, vigilancia de la deriva, desempeño por subgrupo y supervisión humana. Un «funcionaría bien» sin condiciones se corrige como respuesta incompleta.
