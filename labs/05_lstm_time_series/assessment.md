...
>
> [⬅️ 🔁 RNN para texto](../../labs/04_rnn_sequences/assessment.md) · [🏠 Índice de clases](../../parts/README.md) · [🧬 Autoencoder para fraude ➡️](../../labs/06_autoencoder_anomaly/assessment.md)
>
...
| Comparación contra Persistencia, media móvil y Ridge | `metrics.json` y `baseline_metrics.json` | Sin línea base, una métrica no dice si el modelo aporta algo. |
...
**1. ¿Qué decide recordar, olvidar y revelar una LSTM?**
...
**2. Explica con tus palabras: Puertas input, forget y output de una LSTM.**
...
**4. ¿Por qué Persistencia, media móvil y Ridge es una comparación razonable para este problema?**
...
**5. ¿El modelo supera persistencia en períodos de cambio?**
...
**6. ¿Qué aprendiste al realizar esta práctica: Construir ventanas cronológicas, inspeccionar compuertas y comparar el pronóstico con persistencia y media móvil.?**
...
**7. Refuta con evidencia esta idea frecuente: «Barajar una serie temporal antes de partirla produce una evaluación optimista porque permite que el futuro informe al pasado.»**
...
*Qué se busca:* Aquí se evalúa el criterio, no la técnica: licencias y condiciones de uso de `seoul_bike`, representatividad de la población, calibración de las probabilidades, vigilancia de la deriva, desempeño por subgrupo y supervisión humana. Un «funcionaría bien» sin condiciones se corrige como respuesta incompleta.
