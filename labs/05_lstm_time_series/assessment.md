...
**1. Explica con tus palabras: Puertas input, forget y output de una LSTM.**
...
**3. ¿Por qué Persistencia, media móvil y Ridge es una comparación razonable para este problema?**
...
**5. ¿Qué te dice `rmse` que no te dirían las otras métricas?**
