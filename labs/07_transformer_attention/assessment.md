...
>
> [⬅️ 🧬 Autoencoder para fraude](../../labs/06_autoencoder_anomaly/assessment.md) · [🏠 Índice de rutas](../../parts/README.md) · [🎨 GAN generativa ➡️](../../labs/08_gan_generation/assessment.md)
>
...
**1. Explica con tus palabras: Attention(Q,K,V)=softmax(QKᵀ/√d)V.**
