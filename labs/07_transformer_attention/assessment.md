...
>
> [⬅️ 🧬 Autoencoder para fraude](../../labs/06_autoencoder_anomaly/assessment.md) · [🏠 Índice de clases](../../parts/README.md) · [🎨 GAN generativa ➡️](../../labs/08_gan_generation/assessment.md)
>
...
**1. ¿Cómo decide cada palabra a qué otras palabras prestar atención?**
...
**2. Explica con tus palabras: Attention(Q,K,V)=softmax(QKᵀ/√d)V.**
...
**5. ¿La atención observada coincide con evidencia útil para la clase?**
...
**6. ¿Qué aprendiste al realizar esta práctica: Calcular atención escalada, aplicar máscaras y contrastar mapas de atención con cambios reales en la predicción.?**
...
**7. Refuta con evidencia esta idea frecuente: «Un mapa de atención atractivo no es por sí solo una explicación causal de la predicción.»**
