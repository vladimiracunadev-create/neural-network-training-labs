...
> Si alguno te falta, retrocede antes de continuar. Viniendo de [🧬 Autoencoder para fraude](../../labs/06_autoencoder_anomaly/README.md).
...
Es la **ruta 8 de 31** y pertenece a 🔵 [la parte 2, Arquitecturas según la forma del dato](../../parts/02-arquitecturas.md). Llegas desde [🧬 Autoencoder para fraude](../../labs/06_autoencoder_anomaly/README.md) y lo que aprendas aquí lo da por supuesto [🎨 GAN generativa](../../labs/08_gan_generation/README.md).

## 🧠 La idea que se pone a prueba

Este laboratorio trabaja **Attention(Q,K,V)=softmax(QKᵀ/√d)V**.
...
> **La pregunta que deberías poder responder al final:** ¿La atención observada coincide con evidencia útil para la clase?
