...
>
> [⬅️ 🛡️ Regularización](../../labs/19_regularization_dropout_batchnorm/experiments.md) · [🏠 Índice de clases](../../parts/README.md) · [🔍 Explicabilidad ➡️](../../labs/21_explainability/experiments.md)
>
...
Formulada como algo que se puede refutar: **el modelo de este laboratorio supera a CNN sin aumento en `macro_f1`, y la diferencia es mayor que la dispersión entre semillas.**

Qué la haría falsa —y esto también es un resultado que hay que reportar—:

- El modelo no supera a CNN sin aumento.
...
Además de la comparación con la línea base, aquí interesa una pregunta específica: **Medir precisión limpia y robustez**. Es la comparación que da sentido al tema de este laboratorio; la de la línea base solo dice si el modelo sirve, mientras que esta dice *qué parte* del diseño es la que aporta.
...
```bash
neural-labs benchmark --lab 20_data_augmentation \
...
5. **Vuelve a la línea base.** La comparación contra CNN sin aumento es la que dice si todo el aparato de la red neuronal estaba justificado para este problema.
