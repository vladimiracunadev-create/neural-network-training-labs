...
>
> [⬅️ 🛡️ Regularización](../../labs/19_regularization_dropout_batchnorm/assessment.md) · [🏠 Índice de clases](../../parts/README.md) · [🔍 Explicabilidad ➡️](../../labs/21_explainability/assessment.md)
>
...
| Comparación contra CNN sin aumento | `metrics.json` y `baseline_metrics.json` | Sin línea base, una métrica no dice si el modelo aporta algo. |
...
**1. ¿Qué transformaciones conservan la etiqueta y cuáles cambian el problema?**
...
**2. Explica con tus palabras: Invariancias y regularización por transformaciones.**
...
**4. ¿Por qué CNN sin aumento es una comparación razonable para este problema?**
...
**5. ¿La mejora proviene de invariancias coherentes?**
...
**6. ¿Qué aprendiste al realizar esta práctica: Crear una galería de transformaciones y medir precisión limpia, robustez y errores introducidos.?**
...
**7. Refuta con evidencia esta idea frecuente: «Más aumento no siempre ayuda; una transformación inválida introduce etiquetas incorrectas de manera sistemática.»**
