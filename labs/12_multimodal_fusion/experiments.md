...
>
> [⬅️ ♻️ Transfer learning con mascotas](../../labs/11_transfer_learning/experiments.md) · [🏠 Índice de clases](../../parts/README.md) · [🎛️ Búsqueda de hiperparámetros ➡️](../../labs/13_hyperparameter_search/experiments.md)
>
...
Formulada como algo que se puede refutar: **el modelo de este laboratorio supera a Acelerómetro solo, giroscopio solo y regresión logística en `macro_f1`, y la diferencia es mayor que la dispersión entre semillas.**

Qué la haría falsa —y esto también es un resultado que hay que reportar—:

- El modelo no supera a Acelerómetro solo, giroscopio solo y regresión logística.
...
Además de la comparación con la línea base, aquí interesa una pregunta específica: **Ablacionar acelerómetro y giroscopio**. Es la comparación que da sentido al tema de este laboratorio; la de la línea base solo dice si el modelo sirve, mientras que esta dice *qué parte* del diseño es la que aporta.
...
```bash
neural-labs benchmark --lab 12_multimodal_fusion \
...
5. **Vuelve a la línea base.** La comparación contra Acelerómetro solo, giroscopio solo y regresión logística es la que dice si todo el aparato de la red neuronal estaba justificado para este problema.
