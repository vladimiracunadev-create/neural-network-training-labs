...
**1. Explica con tus palabras: f=[f_acc(x_acc); f_gyro(x_gyro)]; y=head(f).**
...
**3. ¿Por qué Acelerómetro solo, giroscopio solo y regresión logística es una comparación razonable para este problema?**
