...
>
> [⬅️ ♻️ Transfer learning con mascotas](../../labs/11_transfer_learning/assessment.md) · [🏠 Índice de clases](../../parts/README.md) · [🎛️ Búsqueda de hiperparámetros ➡️](../../labs/13_hyperparameter_search/assessment.md)
>
...
| Comparación contra Acelerómetro solo, giroscopio solo y regresión logística | `metrics.json` y `baseline_metrics.json` | Sin línea base, una métrica no dice si el modelo aporta algo. |
...
**1. ¿Las modalidades se complementan o una de ellas domina silenciosamente?**
...
**2. Explica con tus palabras: f=[f_acc(x_acc); f_gyro(x_gyro)]; y=head(f).**
...
**4. ¿Por qué Acelerómetro solo, giroscopio solo y regresión logística es una comparación razonable para este problema?**
...
**5. ¿Qué modalidad explica cada actividad?**
...
**6. ¿Qué aprendiste al realizar esta práctica: Comparar cada modalidad, fusión temprana y tardía, y simular la ausencia de un sensor.?**
...
**7. Refuta con evidencia esta idea frecuente: «Concatenar señales no garantiza fusión útil; el modelo puede ignorar una modalidad por completo.»**
...
*Qué se busca:* Aquí se evalúa el criterio, no la técnica: licencias y condiciones de uso de `uci_har`, representatividad de la población, calibración de las probabilidades, vigilancia de la deriva, desempeño por subgrupo y supervisión humana. Un «funcionaría bien» sin condiciones se corrige como respuesta incompleta.
