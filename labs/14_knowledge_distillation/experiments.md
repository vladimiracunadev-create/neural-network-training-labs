...
>
> [⬅️ 🎛️ Búsqueda de hiperparámetros](../../labs/13_hyperparameter_search/experiments.md) · [🏠 Índice de clases](../../parts/README.md) · [🌐 Aprendizaje federado por participante ➡️](../../labs/15_federated_learning/experiments.md)
>
...
Formulada como algo que se puede refutar: **el modelo de este laboratorio supera a Estudiante entrenado solo con etiquetas en `macro_f1`, y la diferencia es mayor que la dispersión entre semillas.**

Qué la haría falsa —y esto también es un resultado que hay que reportar—:

- El modelo no supera a Estudiante entrenado solo con etiquetas.
...
Además de la comparación con la línea base, aquí interesa una pregunta específica: **Comparar calidad, tamaño y latencia**. Es la comparación que da sentido al tema de este laboratorio; la de la línea base solo dice si el modelo sirve, mientras que esta dice *qué parte* del diseño es la que aporta.
...
```bash
neural-labs benchmark --lab 14_knowledge_distillation \
...
5. **Vuelve a la línea base.** La comparación contra Estudiante entrenado solo con etiquetas es la que dice si todo el aparato de la red neuronal estaba justificado para este problema.
