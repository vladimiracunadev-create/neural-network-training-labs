...
>
> [⬅️ 🎨 GAN generativa](../../labs/08_gan_generation/assessment.md) · [🏠 Índice de rutas](../../parts/README.md) · [🕹️ DQN para inventario con demanda real ➡️](../../labs/10_dqn_reinforcement/assessment.md)
>
...
**1. Explica con tus palabras: H^(l+1)=σ(D^-1/2 Â D^-1/2 H^l W^l).**
...
**3. ¿Por qué MLP sin aristas es una comparación razonable para este problema?**
...
**4. ¿Cuánto aporta la estructura de citaciones?**
