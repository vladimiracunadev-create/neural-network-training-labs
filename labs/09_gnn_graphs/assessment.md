...
>
> [⬅️ 🎨 GAN generativa](../../labs/08_gan_generation/assessment.md) · [🏠 Índice de clases](../../parts/README.md) · [🕹️ DQN para inventario con demanda real ➡️](../../labs/10_dqn_reinforcement/assessment.md)
>
...
| Comparación contra MLP sin aristas | `metrics.json` y `baseline_metrics.json` | Sin línea base, una métrica no dice si el modelo aporta algo. |
...
**1. ¿Cuánto aporta conocer las conexiones además de conocer cada nodo?**
...
**2. Explica con tus palabras: H^(l+1)=σ(D^-1/2 A_hat D^-1/2 H^l W^l).**
...
**4. ¿Por qué MLP sin aristas es una comparación razonable para este problema?**
...
**5. ¿Cuánto aporta la estructura de citaciones?**
...
**6. ¿Qué aprendiste al realizar esta práctica: Visualizar vecindarios, retirar aristas y comparar una GNN con una MLP que solo ve atributos.?**
...
**7. Refuta con evidencia esta idea frecuente: «Añadir más capas no siempre incorpora mejor contexto; puede volver indistinguibles las representaciones de los nodos.»**
...
*Qué se busca:* Aquí se evalúa el criterio, no la técnica: licencias y condiciones de uso de `cora`, representatividad de la población, calibración de las probabilidades, vigilancia de la deriva, desempeño por subgrupo y supervisión humana. Un «funcionaría bien» sin condiciones se corrige como respuesta incompleta.
