...
>
> [⬅️ 🌐 Aprendizaje federado por participante](../../labs/15_federated_learning/experiments.md) · [🏠 Índice de clases](../../parts/README.md) · [📐 Activaciones y funciones de pérdida ➡️](../../labs/17_activations_and_losses/experiments.md)
>
...
Formulada como algo que se puede refutar: **el modelo de este laboratorio supera a Regresión logística multinomial en `macro_f1`, y la diferencia es mayor que la dispersión entre semillas.**

Qué la haría falsa —y esto también es un resultado que hay que reportar—:

- El modelo no supera a Regresión logística multinomial.
...
Además de la comparación con la línea base, aquí interesa una pregunta específica: **Validar derivadas capa por capa**. Es la comparación que da sentido al tema de este laboratorio; la de la línea base solo dice si el modelo sirve, mientras que esta dice *qué parte* del diseño es la que aporta.
...
```bash
neural-labs benchmark --lab 16_backpropagation_manual \
...
5. **Vuelve a la línea base.** La comparación contra Regresión logística multinomial es la que dice si todo el aparato de la red neuronal estaba justificado para este problema.
