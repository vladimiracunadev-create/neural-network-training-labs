...
>
> [⬅️ 🌐 Aprendizaje federado por participante](../../labs/15_federated_learning/assessment.md) · [🏠 Índice de clases](../../parts/README.md) · [📐 Activaciones y funciones de pérdida ➡️](../../labs/17_activations_and_losses/assessment.md)
>
...
| Comparación contra Regresión logística multinomial | `metrics.json` y `baseline_metrics.json` | Sin línea base, una métrica no dice si el modelo aporta algo. |
...
**1. ¿Cómo se reparte la responsabilidad del error entre todas las capas?**
...
**2. Explica con tus palabras: Regla de la cadena para W2, b2, W1 y b1.**
...
**4. ¿Por qué Regresión logística multinomial es una comparación razonable para este problema?**
...
**5. ¿Dónde aparecen gradientes que explotan o desaparecen?**
...
**6. ¿Qué aprendiste al realizar esta práctica: Derivar una MLP capa por capa, comprobar el gradiente y graficar su norma a distintas profundidades.?**
...
**7. Refuta con evidencia esta idea frecuente: «Un programa que ejecuta backward sin error puede seguir teniendo gradientes matemáticamente incorrectos.»**
...
*Qué se busca:* Aquí se evalúa el criterio, no la técnica: licencias y condiciones de uso de `iris`, representatividad de la población, calibración de las probabilidades, vigilancia de la deriva, desempeño por subgrupo y supervisión humana. Un «funcionaría bien» sin condiciones se corrige como respuesta incompleta.
