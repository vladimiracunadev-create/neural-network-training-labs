...
<!-- nav-top -->
> 🧭 **Clase 02 / 31** · 🟢 [Módulo 1 — Fundamentos: de la derivada a la primera red](../../parts/01-fundamentos.md)
>
> [⬅️ 🔢 Neurona con NumPy](../../labs/00_numpy_neuron/assessment.md) · [🏠 Índice de clases](../../parts/README.md) · [🌀 MLP multiclase ➡️](../../labs/02_mlp_nonlinear/assessment.md)
>
...
| Comparación contra Regresión logística | `metrics.json` y `baseline_metrics.json` | Sin línea base, una métrica no dice si el modelo aporta algo. |
...
**1. ¿Qué calcula PyTorch por nosotros cuando llamamos a backward()?**
...
**2. Explica con tus palabras: z=xW+b; BCEWithLogitsLoss.**
...
**4. ¿Por qué Regresión logística es una comparación razonable para este problema?**
...
**5. ¿Qué ejemplos no puede separar un único hiperplano?**
...
**6. ¿Qué aprendiste al realizar esta práctica: Inspeccionar tensores y gradientes, comparar el cálculo manual con autograd y visualizar la frontera antes y después de normalizar.?**
...
**7. Refuta con evidencia esta idea frecuente: «backward() no actualiza los pesos; calcula gradientes. El optimizador realiza la actualización en un paso separado.»**
...
*Qué se busca:* Aquí se evalúa el criterio, no la técnica: licencias y condiciones de uso de `banknote_authentication`, representatividad de la población, calibración de las probabilidades, vigilancia de la deriva, desempeño por subgrupo y supervisión humana. Un «funcionaría bien» sin condiciones se corrige como respuesta incompleta.
...
|---|:---:|---|
| [🔢 Neurona con NumPy](../../labs/00_numpy_neuron/README.md) | [Las 31 clases](../../parts/README.md) | [🌀 MLP multiclase](../../labs/02_mlp_nonlinear/README.md) |
...
🟢 [Módulo 1 — Fundamentos: de la derivada a la primera red](../../parts/01-fundamentos.md) · [🏠 Portada del repositorio](../../README.md) · [🌐 Sitio de estudio](https://vladimiracunadev-create.github.io/neural-network-training-labs/labs/01_pytorch_perceptron/index.html) · [🖥️ Página HTML local](index.html)
<!-- /nav-bottom -->
