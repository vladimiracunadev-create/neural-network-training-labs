...
>
> [⬅️ 🔢 Neurona con NumPy](../../labs/00_numpy_neuron/experiments.md) · [🏠 Índice de clases](../../parts/README.md) · [🌀 MLP multiclase ➡️](../../labs/02_mlp_nonlinear/experiments.md)
>
...
Formulada como algo que se puede refutar: **el modelo de este laboratorio supera a Regresión logística en `f1`, y la diferencia es mayor que la dispersión entre semillas.**

Qué la haría falsa —y esto también es un resultado que hay que reportar—:

- El modelo no supera a Regresión logística.
...
Además de la comparación con la línea base, aquí interesa una pregunta específica: **Verificar la frontera de decisión y el efecto de la normalización**. Es la comparación que da sentido al tema de este laboratorio; la de la línea base solo dice si el modelo sirve, mientras que esta dice *qué parte* del diseño es la que aporta.
...
```bash
neural-labs benchmark --lab 01_pytorch_perceptron \
...
5. **Vuelve a la línea base.** La comparación contra Regresión logística es la que dice si todo el aparato de la red neuronal estaba justificado para este problema.
