# Guía docente — Clase 02: Perceptrón con PyTorch
...
> **¿Qué calcula PyTorch por nosotros cuando llamamos a backward()?**
...
Inspeccionar tensores y gradientes, comparar el cálculo manual con autograd y visualizar la frontera antes y después de normalizar.
...
> **Idea engañosa:** backward() no actualiza los pesos; calcula gradientes. El optimizador realiza la actualización en un paso separado.
