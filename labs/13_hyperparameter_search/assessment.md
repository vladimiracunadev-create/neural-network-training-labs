...
>
> [⬅️ 🔀 Fusión de sensores](../../labs/12_multimodal_fusion/assessment.md) · [🏠 Índice de rutas](../../parts/README.md) · [⚗️ Destilación de conocimiento ➡️](../../labs/14_knowledge_distillation/assessment.md)
>
...
**1. Explica con tus palabras: Selección por validación; test se usa solo tras elegir la mejor prueba.**
...
**3. ¿Por qué Regresión logística es una comparación razonable para este problema?**
