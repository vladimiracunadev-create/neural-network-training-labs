...
>
> [⬅️ 🔀 Fusión de sensores](../../labs/12_multimodal_fusion/assessment.md) · [🏠 Índice de clases](../../parts/README.md) · [⚗️ Destilación de conocimiento ➡️](../../labs/14_knowledge_distillation/assessment.md)
>
...
**1. ¿Cómo buscar mejores configuraciones sin convertir validation en otro conjunto de entrenamiento?**
...
**2. Explica con tus palabras: Selección por validación; test se usa solo tras elegir la mejor prueba.**
...
**5. ¿El mejor trial generaliza a semillas nuevas?**
...
**6. ¿Qué aprendiste al realizar esta práctica: Leer una trayectoria de búsqueda, comparar muestreo aleatorio y rejilla y justificar el presupuesto experimental.?**
...
**7. Refuta con evidencia esta idea frecuente: «El mejor ensayo observado no es necesariamente la mejor configuración generalizable, especialmente con muchas comparaciones.»**
