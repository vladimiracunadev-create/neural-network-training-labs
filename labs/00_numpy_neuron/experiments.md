...
>
> ⬅️ *inicio del recorrido* · [🏠 Índice de clases](../../parts/README.md) · [🧩 Perceptrón con PyTorch ➡️](../../labs/01_pytorch_perceptron/experiments.md)
>
...
Formulada como algo que se puede refutar: **el modelo de este laboratorio supera a DummyClassifier y regresión logística de scikit-learn en `f1`, y la diferencia es mayor que la dispersión entre semillas.**

Qué la haría falsa —y esto también es un resultado que hay que reportar—:

- El modelo no supera a DummyClassifier y regresión logística de scikit-learn.
...
Además de la comparación con la línea base, aquí interesa una pregunta específica: **Comparar el gradiente analítico con diferencias finitas**. Es la comparación que da sentido al tema de este laboratorio; la de la línea base solo dice si el modelo sirve, mientras que esta dice *qué parte* del diseño es la que aporta.
...
```bash
neural-labs benchmark --lab 00_numpy_neuron \
...
5. **Vuelve a la línea base.** La comparación contra DummyClassifier y regresión logística de scikit-learn es la que dice si todo el aparato de la red neuronal estaba justificado para este problema.
