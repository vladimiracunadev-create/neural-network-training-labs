# Guía docente — Clase 01: Neurona con NumPy
...
> **¿Cómo aprende una neurona si no existe autograd?**
...
Derivar el gradiente, comprobarlo con diferencias finitas y observar cómo la escala de las variables cambia el descenso.
...
> **Idea engañosa:** El gradiente no indica dónde está el mínimo; indica la pendiente local y cuánto cambia la pérdida en ese punto.
