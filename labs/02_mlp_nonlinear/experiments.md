...
>
> [⬅️ 🧩 Perceptrón con PyTorch](../../labs/01_pytorch_perceptron/experiments.md) · [🏠 Índice de clases](../../parts/README.md) · [🖼️ CNN para visión ➡️](../../labs/03_cnn_vision/experiments.md)
>
...
Formulada como algo que se puede refutar: **el modelo de este laboratorio supera a Regresión logística multinomial y Random Forest en `macro_f1`, y la diferencia es mayor que la dispersión entre semillas.**

Qué la haría falsa —y esto también es un resultado que hay que reportar—:

- El modelo no supera a Regresión logística multinomial y Random Forest.
...
Además de la comparación con la línea base, aquí interesa una pregunta específica: **Comparar profundidad, activación y dropout**. Es la comparación que da sentido al tema de este laboratorio; la de la línea base solo dice si el modelo sirve, mientras que esta dice *qué parte* del diseño es la que aporta.
...
5. **Vuelve a la línea base.** La comparación contra Regresión logística multinomial y Random Forest es la que dice si todo el aparato de la red neuronal estaba justificado para este problema.
