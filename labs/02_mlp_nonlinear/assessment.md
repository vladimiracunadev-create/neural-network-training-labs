...
>
> [⬅️ 🧩 Perceptrón con PyTorch](../../labs/01_pytorch_perceptron/assessment.md) · [🏠 Índice de rutas](../../parts/README.md) · [🖼️ CNN para visión ➡️](../../labs/03_cnn_vision/assessment.md)
>
...
**1. Explica con tus palabras: h=ReLU(xW1+b1); logits=hW2+b2.**
...
**3. ¿Por qué Regresión logística multinomial y Random Forest es una comparación razonable para este problema?**
