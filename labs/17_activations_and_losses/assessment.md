...
>
> [⬅️ ∂ Backpropagation manual](../../labs/16_backpropagation_manual/assessment.md) · [🏠 Índice de rutas](../../parts/README.md) · [⚙️ Optimizadores y schedulers ➡️](../../labs/18_optimizers_and_schedulers/assessment.md)
>
...
**1. Explica con tus palabras: Derivadas, saturación y sensibilidad de CrossEntropy/Focal Loss.**
...
**3. ¿Por qué Regresión ordinal y Random Forest es una comparación razonable para este problema?**
...
**5. ¿Qué te dice `macro_f1` que no te dirían las otras métricas?**
...
**6. ¿Qué cambiarías antes de usar este modelo fuera del laboratorio?**
