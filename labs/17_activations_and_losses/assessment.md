...
>
> [⬅️ ∂ Backpropagation manual](../../labs/16_backpropagation_manual/assessment.md) · [🏠 Índice de clases](../../parts/README.md) · [⚙️ Optimizadores y schedulers ➡️](../../labs/18_optimizers_and_schedulers/assessment.md)
>
...
| Comparación contra Regresión ordinal y Random Forest | `metrics.json` y `baseline_metrics.json` | Sin línea base, una métrica no dice si el modelo aporta algo. |
...
**1. ¿Cómo cambia lo que aprende una red al cambiar activación o pérdida?**
...
**2. Explica con tus palabras: Derivadas, saturación y sensibilidad de CrossEntropy/Focal Loss.**
...
**4. ¿Por qué Regresión ordinal y Random Forest es una comparación razonable para este problema?**
...
**5. ¿La conclusión se mantiene en varias semillas?**
...
**6. ¿Qué aprendiste al realizar esta práctica: Comparar funciones y derivadas, provocar saturación y relacionar pérdidas con desbalance y costos de error.?**
...
**7. Refuta con evidencia esta idea frecuente: «Elegir una pérdida es una decisión sobre qué errores importan, no un detalle intercambiable de implementación.»**
...
*Qué se busca:* Aquí se evalúa el criterio, no la técnica: licencias y condiciones de uso de `wine_quality`, representatividad de la población, calibración de las probabilidades, vigilancia de la deriva, desempeño por subgrupo y supervisión humana. Un «funcionaría bien» sin condiciones se corrige como respuesta incompleta.
