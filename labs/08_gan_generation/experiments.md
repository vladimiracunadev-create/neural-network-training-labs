...
>
> [⬅️ 🔭 Transformer para noticias](../../labs/07_transformer_attention/experiments.md) · [🏠 Índice de clases](../../parts/README.md) · [🕸️ GNN sobre red de citas ➡️](../../labs/09_gnn_graphs/experiments.md)
>
...
Formulada como algo que se puede refutar: **el modelo de este laboratorio supera a PCA generativa y distribución real de referencia en `f1`, y la diferencia es mayor que la dispersión entre semillas.**

Qué la haría falsa —y esto también es un resultado que hay que reportar—:

- El modelo no supera a PCA generativa y distribución real de referencia.
...
Además de la comparación con la línea base, aquí interesa una pregunta específica: **Vigilar colapso de modos y estabilidad**. Es la comparación que da sentido al tema de este laboratorio; la de la línea base solo dice si el modelo sirve, mientras que esta dice *qué parte* del diseño es la que aporta.
...
```bash
neural-labs benchmark --lab 08_gan_generation \
...
5. **Vuelve a la línea base.** La comparación contra PCA generativa y distribución real de referencia es la que dice si todo el aparato de la red neuronal estaba justificado para este problema.
