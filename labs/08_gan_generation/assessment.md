...
**1. Explica con tus palabras: min_G max_D E[log D(x)] + E[log(1-D(G(z)))].**
...
**3. ¿Por qué PCA generativa y distribución real de referencia es una comparación razonable para este problema?**
