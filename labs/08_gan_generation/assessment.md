...
>
> [⬅️ 🔭 Transformer para noticias](../../labs/07_transformer_attention/assessment.md) · [🏠 Índice de clases](../../parts/README.md) · [🕸️ GNN sobre red de citas ➡️](../../labs/09_gnn_graphs/assessment.md)
>
...
| Comparación contra PCA generativa y distribución real de referencia | `metrics.json` y `baseline_metrics.json` | Sin línea base, una métrica no dice si el modelo aporta algo. |
...
**1. ¿Cómo sabemos si un generador aprendió diversidad y no solo unas pocas imágenes convincentes?**
...
**2. Explica con tus palabras: min_G max_D E[log D(x)] + E[log(1-D(G(z)))].**
...
**4. ¿Por qué PCA generativa y distribución real de referencia es una comparación razonable para este problema?**
...
**5. ¿Cómo se distingue diversidad real de ruido visual?**
...
**6. ¿Qué aprendiste al realizar esta práctica: Recorrer el espacio latente, comparar vecinos y medir diversidad junto con la estabilidad adversarial.?**
...
**7. Refuta con evidencia esta idea frecuente: «Una pérdida baja del generador no garantiza calidad ni cobertura de todos los modos de los datos.»**
