...
<!-- nav-top -->
> 🧭 **Clase 04 / 31** · 🔵 [Módulo 2 — Arquitecturas según la forma del dato](../../parts/02-arquitecturas.md)
>
> [⬅️ 🌀 MLP multiclase](../../labs/02_mlp_nonlinear/assessment.md) · [🏠 Índice de clases](../../parts/README.md) · [🔁 RNN para texto ➡️](../../labs/04_rnn_sequences/assessment.md)
>
...
| Comparación contra Clasificador lineal sobre píxeles | `metrics.json` y `baseline_metrics.json` | Sin línea base, una métrica no dice si el modelo aporta algo. |
...
**1. ¿Por qué una convolución reconoce un patrón aunque cambie de posición?**
...
**2. Explica con tus palabras: Convolución, pooling, normalización y clasificación.**
...
**4. ¿Por qué Clasificador lineal sobre píxeles es una comparación razonable para este problema?**
...
**5. ¿Qué clases concentran errores visualmente plausibles?**
...
**6. ¿Qué aprendiste al realizar esta práctica: Mirar filtros y mapas de activación, calcular el campo receptivo y estudiar errores por clase en CIFAR-10.?**
...
**7. Refuta con evidencia esta idea frecuente: «Una activación intensa no demuestra que la red haya comprendido un objeto; solo muestra respuesta a un patrón aprendido.»**
...
|---|:---:|---|
| [🌀 MLP multiclase](../../labs/02_mlp_nonlinear/README.md) | [Las 31 clases](../../parts/README.md) | [🔁 RNN para texto](../../labs/04_rnn_sequences/README.md) |
...
🔵 [Módulo 2 — Arquitecturas según la forma del dato](../../parts/02-arquitecturas.md) · [🏠 Portada del repositorio](../../README.md) · [🌐 Sitio de estudio](https://vladimiracunadev-create.github.io/neural-network-training-labs/labs/03_cnn_vision/index.html) · [🖥️ Página HTML local](index.html)
<!-- /nav-bottom -->
