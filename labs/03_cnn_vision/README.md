...
>
> [⬅️ 🌀 MLP multiclase](../../labs/02_mlp_nonlinear/README.md) · [🏠 Índice de clases](../../parts/README.md) · [🔁 RNN para texto ➡️](../../labs/04_rnn_sequences/README.md)
>
...
> **Pregunta esencial:** ¿Por qué una convolución reconoce un patrón aunque cambie de posición?
...
*Mapa de esta clase: De píxeles a rasgos visuales. La figura no es decorativa; úsala para explicar el mecanismo con tus propias palabras.*

## 🎯 Qué vas a aprender y construir

Entrenar una CNN y analizar errores sobre fotografías reales de diez clases.

**Práctica propia de esta clase:** Mirar filtros y mapas de activación, calcular el campo receptivo y estudiar errores por clase en CIFAR-10.

Es la **clase 04 de 31** del programa y pertenece a 🔵 el módulo 2, *Arquitecturas según la forma del dato*. Llegas desde **MLP multiclase** y lo que hagas aquí lo da por supuesto **RNN para texto**.
...
> Una activación intensa no demuestra que la red haya comprendido un objeto; solo muestra respuesta a un patrón aprendido.
...
jupyter lab labs/03_cnn_vision/notebook.ipynb
```
