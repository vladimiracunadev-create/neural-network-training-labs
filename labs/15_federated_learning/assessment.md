...
>
> [⬅️ ⚗️ Destilación de conocimiento](../../labs/14_knowledge_distillation/assessment.md) · [🏠 Índice de clases](../../parts/README.md) · [∂ Backpropagation manual ➡️](../../labs/16_backpropagation_manual/assessment.md)
>
...
| Comparación contra Entrenamiento centralizado | `metrics.json` y `baseline_metrics.json` | Sin línea base, una métrica no dice si el modelo aporta algo. |
...
**1. ¿Qué ocurre cuando cada participante observa una realidad diferente?**
...
**2. Explica con tus palabras: w_{t+1}=Σ_k(n_k/n)w_k.**
...
**4. ¿Por qué Entrenamiento centralizado es una comparación razonable para este problema?**
...
**5. ¿Qué clientes quedan perjudicados por la agregación?**
...
**6. ¿Qué aprendiste al realizar esta práctica: Visualizar heterogeneidad por cliente y comparar convergencia global con desempeño individual.?**
...
**7. Refuta con evidencia esta idea frecuente: «No mover los datos no garantiza privacidad; las actualizaciones también pueden revelar información.»**
...
*Qué se busca:* Aquí se evalúa el criterio, no la técnica: licencias y condiciones de uso de `uci_har_subjects`, representatividad de la población, calibración de las probabilidades, vigilancia de la deriva, desempeño por subgrupo y supervisión humana. Un «funcionaría bien» sin condiciones se corrige como respuesta incompleta.
