...
| 📏 Línea base a superar | Regresión logística calibrada |
...
> Si alguno te falta, retrocede antes de continuar. Viniendo de [🔍 Explicabilidad](../../labs/21_explainability/README.md).
...
Es la **ruta 23 de 31** y pertenece a ⚫ [la parte 6, Confiar en el modelo y sacarlo del cuaderno](../../parts/06-confianza-y-despliegue.md). Llegas desde [🔍 Explicabilidad](../../labs/21_explainability/README.md) y lo que aprendas aquí lo da por supuesto [📦 Exportación e inferencia](../../labs/23_model_export_and_inference/README.md).

## 🧠 La idea que se pone a prueba

Este laboratorio trabaja **Calibrar logits z/T en validación y evaluar una vez en test**.
...
> **La pregunta que deberías poder responder al final:** ¿Una mayor accuracy implica probabilidades confiables?

**Métricas que se reportan:** `accuracy`, `f1`, `roc_auc`, `brier`, `ece`. La selección del modelo se decide con `f1` sobre `validation`.
