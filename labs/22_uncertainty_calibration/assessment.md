...
>
> [⬅️ 🔍 Explicabilidad](../../labs/21_explainability/assessment.md) · [🏠 Índice de clases](../../parts/README.md) · [📦 Exportación e inferencia ➡️](../../labs/23_model_export_and_inference/assessment.md)
>
...
| Comparación contra Regresión logística calibrada | `metrics.json` y `baseline_metrics.json` | Sin línea base, una métrica no dice si el modelo aporta algo. |
...
**1. ¿Qué significa realmente que un modelo anuncie 80 % de confianza?**
...
**2. Explica con tus palabras: Calibrar logits z/T en validación y evaluar una vez en test.**
...
**4. ¿Por qué Regresión logística calibrada es una comparación razonable para este problema?**
...
**5. ¿Una mayor accuracy implica probabilidades confiables?**
...
**6. ¿Qué aprendiste al realizar esta práctica: Construir un diagrama de confiabilidad, calcular ECE y aplicar temperature scaling sin tocar test.?**
...
**7. Refuta con evidencia esta idea frecuente: «Una alta exactitud no implica probabilidades bien calibradas; son propiedades diferentes.»**
